<script lang="ts">
    ...
    settingsStrings.icon = sicon == undefined ? DEFAULT_CONFIG.icon : sicon;
    settingsStrings.depth = sdepth == undefined ? DEFAULT_CONFIG.depth : sdepth;
    settingsStrings.listType = slistType == undefined ? DEFAULT_CONFIG.listType : slistType;
    settingsStrings.linkType = slinkType == undefined ? DEFAULT_CONFIG.linkType : slinkType;
    settingsStrings.docBuilder = sdocBuilder == undefined ? DEFAULT_CONFIG.docBuilder : sdocBuilder;
    settingsStrings.col = scol == undefined ? DEFAULT_CONFIG.col : scol;
    let fold = sfold == undefined ? DEFAULT_CONFIG.fold : sfold;
    let autoUpdate = sicon == undefined ? DEFAULT_CONFIG.autoUpdate : sautoUpdate;
    let at = sat == undefined ? DEFAULT_CONFIG.at : sat;
    let outlineType = soutlineType == undefined ? DEFAULT_CONFIG.outlineType : soutlineType;
    let outlineAutoUpdate = soutlineAutoUpdate == undefined ? DEFAULT_CONFIG.outlineAutoUpdate : soutlineAutoUpdate;
    let listTypeOutline = slistTypeOutline == undefined ? DEFAULT_CONFIG.listTypeOutline : slistTypeOutline;
